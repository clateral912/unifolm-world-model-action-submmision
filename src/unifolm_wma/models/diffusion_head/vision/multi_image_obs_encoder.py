...
# =======OPTIMIZATION: CUDA GRAPH COMPATIBLE GPU NORMALIZER=======
# Replace torchvision.transforms.Normalize which dynamically creates tensors
# in forward() (incompatible with CUDA Graph capture) with a module that
# pre-registers mean/std as buffers during __init__.
        ...
        for key, attr in obs_shape_meta.items():
            ...
            if type == 'rgb':
                ...
                if not use_dinoSiglip:
                    ...
                    if imagenet_norm:
                        # =======OPTIMIZATION: CUDA GRAPH COMPATIBLE NORMALIZER=======
                        this_normalizer = GPUNormalizer(
